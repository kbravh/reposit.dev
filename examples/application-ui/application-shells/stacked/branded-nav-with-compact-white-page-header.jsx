      ...
      <div className="min-h-full">
              ...
              <div className="hidden md:block">
                <div className="ml-4 flex items-center md:ml-6">
                  ...
                  <Menu as="div" className="relative ml-3">
                    <div>
                      <MenuButton className="relative flex max-w-xs items-center rounded-full bg-indigo-600 text-sm focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-indigo-600">
                        <span className="-inset-1.5 absolute" />
        ...
        <header className="bg-white shadow-xs">
          <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
            <h1 className="font-semibold text-gray-900 text-lg/6">Dashboard</h1>
          </div>
        </header>
        <main>

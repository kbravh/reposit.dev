      ...
      {projects.map(project => (
        ...
        >
            ...
            <div className="flex items-start gap-x-3">
              ...
              <p
                className={classNames(
                  ...
                  'mt-0.5 whitespace-nowrap rounded-md px-1.5 py-0.5 font-medium text-xs ring-1 ring-inset'
                )}
              >
                {project.status}
              </p>
          ...
          <div className="flex flex-none items-center gap-x-4">
            <a
              href={project.href}
              className="hidden rounded-md bg-white px-2.5 py-1.5 font-semibold text-gray-900 text-sm shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 sm:block"
            >

...
export default function Example() {
	return (
		<div className="lg:border-gray-200 lg:border-t lg:border-b">
			<nav
				aria-label="Progress"
				className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"
			>
				<ol className="overflow-hidden rounded-md lg:flex lg:rounded-none lg:border-gray-200 lg:border-r lg:border-l">
								...
								{step.status === "complete" ? (
									<a href={step.href} className="group">
										...
										<span
											className={classNames(
												stepIdx !== 0 ? "lg:pl-9" : "",
												"flex items-start px-6 py-5 font-medium text-sm",
											)}
										>

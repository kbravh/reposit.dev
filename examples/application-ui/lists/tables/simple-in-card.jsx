						...
						<div className="overflow-hidden shadow-sm ring-1 ring-black/5 sm:rounded-lg">
							<table className="min-w-full divide-y divide-gray-300">
								...
								<tbody className="divide-y divide-gray-200 bg-white">
									{people.map((person) => (
										<tr key={person.email}>
											<td className="whitespace-nowrap py-4 pr-3 pl-4 font-medium text-gray-900 text-sm sm:pl-6">
												{person.name}
											</td>
											...
											<td className="relative whitespace-nowrap py-4 pr-4 pl-3 text-right font-medium text-sm sm:pr-6">
												<a
													href="#"

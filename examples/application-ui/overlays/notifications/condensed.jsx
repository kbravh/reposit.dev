							...
							<div className="p-4">
								<div className="flex items-center">
									<div className="flex w-0 flex-1 justify-between">
										<p className="w-0 flex-1 font-medium text-gray-900 text-sm">
											Discussion archived
										</p>
										<button
											type="button"
											className="ml-3 shrink-0 rounded-md bg-white font-medium text-indigo-600 text-sm hover:text-indigo-500 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
										>
											Undo
										</button>
									</div>

						...
						<table className="min-w-full divide-y divide-gray-300">
							<thead>
								<tr>
									<th
										scope="col"
										className="py-3 pr-3 pl-4 text-left font-medium text-gray-500 text-xs uppercase tracking-wide sm:pl-0"
									>
										Name
									</th>
									<th
										scope="col"
										className="px-3 py-3 text-left font-medium text-gray-500 text-xs uppercase tracking-wide"
									>
										Title
									</th>
									<th

			...
			<TabGroup>
				<div className="group flex items-center">
					<TabList className="flex gap-2">
						<Tab className="rounded-md border border-transparent bg-white px-3 py-1.5 font-medium text-gray-500 text-sm hover:bg-gray-100 hover:text-gray-900 data-selected:bg-gray-100 data-selected:text-gray-900 data-selected:hover:bg-gray-200">
							Write
						</Tab>
						<Tab className="rounded-md border border-transparent bg-white px-3 py-1.5 font-medium text-gray-500 text-sm hover:bg-gray-100 hover:text-gray-900 data-selected:bg-gray-100 data-selected:text-gray-900 data-selected:hover:bg-gray-200">
							Preview
				...
				<TabPanels className="mt-2">
					...
					<TabPanel className="-m-0.5 rounded-lg p-0.5">
						<div className="border-gray-200 border-b">
							<div className="mx-px mt-px px-3 pt-2 pb-12 text-gray-800 text-sm">

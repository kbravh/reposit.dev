		...
		<div>
			...
			<div className="mt-6">
				<dl className="grid grid-cols-1 sm:grid-cols-2">
					<div className="border-gray-100 border-t px-4 py-6 sm:col-span-1 sm:px-0">
						<dt className="font-medium text-gray-900 text-sm/6">Full name</dt>
						<dd className="mt-1 text-gray-700 text-sm/6 sm:mt-2">
							Margot Foster
						</dd>
					</div>
					<div className="border-gray-100 border-t px-4 py-6 sm:col-span-1 sm:px-0">
					...
					<div className="border-gray-100 border-t px-4 py-6 sm:col-span-1 sm:px-0">
						...
						<dd className="mt-1 text-gray-700 text-sm/6 sm:mt-2">$120,000</dd>
					</div>

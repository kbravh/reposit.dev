											...
											<div className="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
												<div>
													<label
														...
														className="block font-medium text-gray-900 text-sm/6 sm:mt-1.5"
													>
														Project name
													</label>
												</div>
												...
												<div className="space-y-5 sm:col-span-2">
													...
													<div className="flex flex-col items-start space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
														<div>
															<a
																href="#"
																className="group flex items-center space-x-2.5 font-medium text-indigo-600 text-sm hover:text-indigo-900"
															>
																<LinkIcon
																	aria-hidden="true"
														...
														<div>
															<a
																href="#"
																className="group flex items-center space-x-2.5 text-gray-500 text-sm hover:text-gray-900"
															>
																<QuestionMarkCircleIcon
																	aria-hidden="true"

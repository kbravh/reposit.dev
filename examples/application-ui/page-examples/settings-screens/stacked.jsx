  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl pt-16 lg:flex lg:gap-x-16 lg:px-8">
        ...
        <aside className="flex overflow-x-auto border-gray-900/5 border-b py-4 lg:block lg:w-64 lg:flex-none lg:border-0 lg:py-20">
                ...
                <li key={item.name}>
                  <a
                    ...
                    className={classNames(
                      ...
                      'group flex gap-x-3 rounded-md py-2 pr-3 pl-2 font-semibold text-sm/6'
                    )}
                  >
                    <item.icon
                      aria-hidden="true"
        ...
        <main className="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-20">
          <div className="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
            <div>
              ...
              <dl className="mt-6 divide-y divide-gray-100 border-gray-200 border-t text-sm/6">
            ...
            <div>
              ...
              <ul className="mt-6 divide-y divide-gray-100 border-gray-200 border-t text-sm/6">
              ...
              <div className="flex border-gray-100 border-t pt-6">
                <button
                  type="button"
                ...
                <Field className="flex pt-6">
                  ...
                  <dd className="flex flex-auto items-center justify-end">
                    <Switch
                      ...
                      className="group flex w-8 cursor-pointer rounded-full bg-gray-200 p-px ring-1 ring-gray-900/5 ring-inset transition-colors duration-200 ease-in-out focus-visible:outline-2 focus-visible:outline-indigo-600 focus-visible:outline-offset-2 data-checked:bg-indigo-600"
                    >
                      <span
                        aria-hidden="true"

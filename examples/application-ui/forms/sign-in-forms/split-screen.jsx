        ...
        <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div>
              ...
              />
              <h2 className="mt-8 font-bold text-2xl/9 text-gray-900 tracking-tight">
                Sign in to your account
              </h2>
              <p className="mt-2 text-gray-500 text-sm/6">
                Not a member?{' '}
                <a
                  href="#"
            ...
            <div className="mt-10">
              ...
              <div className="mt-10">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <a
                    href="#"
                    className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 font-semibold text-gray-900 text-sm shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus-visible:ring-transparent"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      aria-hidden="true"

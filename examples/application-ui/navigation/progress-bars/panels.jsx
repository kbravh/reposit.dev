					...
					<li key={step.name} className="relative md:flex md:flex-1">
						{step.status === "complete" ? (
							<a href={step.href} className="group flex w-full items-center">
								<span className="flex items-center px-6 py-4 font-medium text-sm">
									...
									<span className="ml-4 font-medium text-gray-900 text-sm">
										{step.name}
									</span>
								</span>
							</a>
							...
							>
								...
								<span className="ml-4 font-medium text-indigo-600 text-sm">
									{step.name}
								</span>
							</a>
						) : (
							<a href={step.href} className="group flex items-center">
								<span className="flex items-center px-6 py-4 font-medium text-sm">
									...
									<span className="ml-4 font-medium text-gray-500 text-sm group-hover:text-gray-900">
										{step.name}
									</span>
								</span>
							</a>

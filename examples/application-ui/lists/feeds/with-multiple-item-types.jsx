								...
								{activityItem.type === "comment" ? (
									<>
										<div className="relative">
											...
											<span className="-right-1 -bottom-0.5 absolute rounded-tl bg-white px-0.5 py-px">
												<ChatBubbleLeftEllipsisIcon
													aria-hidden="true"
									...
									<>
										...
										<div className="min-w-0 flex-1 py-0">
											<div className="text-gray-500 text-sm/8">
												...
												<span className="mr-0.5">
													{activityItem.tags.map((tag) => (
														<Fragment key={tag.name}>
															<a
																href={tag.href}
																className="inline-flex items-center gap-x-1.5 rounded-full px-2 py-1 font-medium text-gray-900 text-xs ring-1 ring-gray-200 ring-inset"
															>
																<svg
																	viewBox="0 0 6 6"
																	aria-hidden="true"

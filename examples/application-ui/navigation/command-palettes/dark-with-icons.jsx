					...
					>
						...
						{(query === "" || filteredProjects.length > 0) && (
							...
							>
								<li className="p-2">
									{query === "" && (
										<h2 className="mt-4 mb-2 px-3 font-semibold text-gray-200 text-xs">
											Recent searches
										</h2>
									)}
										...
										{(query === "" ? recent : filteredProjects).map(
											(project) => (
												<ComboboxOption
													key={project.id}
													value={project}
													className="group flex cursor-default select-none items-center rounded-md px-3 py-2 data-focus:bg-gray-800 data-focus:text-white data-focus:outline-hidden"
												>
													<FolderIcon
										...
										<ul className="text-gray-400 text-sm">
											{quickActions.map((action) => (
												...
												>
													...
													<span className="ml-3 flex-none font-semibold text-gray-400 text-xs">

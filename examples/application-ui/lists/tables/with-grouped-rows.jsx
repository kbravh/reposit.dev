						...
						<table className="min-w-full">
							<thead className="bg-white">
								<tr>
									<th
										scope="col"
										className="py-3.5 pr-3 pl-4 text-left font-semibold text-gray-900 text-sm sm:pl-3"
									>
										Name
									</th>
									<th
									...
									<Fragment key={location.name}>
										<tr className="border-gray-200 border-t">
											<th
												scope="colgroup"
												colSpan={5}
												className="bg-gray-50 py-2 pr-3 pl-4 text-left font-semibold text-gray-900 text-sm sm:pl-3"
											>
												{location.name}
											</th>
										</tr>
										{location.people.map((person, personIdx) => (
											...
											>
												<td className="whitespace-nowrap py-4 pr-3 pl-4 font-medium text-gray-900 text-sm sm:pl-3">
													{person.name}
												</td>
												...
												<td className="relative whitespace-nowrap py-4 pr-4 pl-3 text-right font-medium text-sm sm:pr-3">
													<a
														href="#"

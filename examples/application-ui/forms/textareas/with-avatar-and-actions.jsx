              ...
              <div className="flex items-center">
                <Listbox value={selected} onChange={setSelected}>
                  ...
                  <div className="relative">
                    ...
                    <ListboxOptions
                      transition
                      className="-ml-6 absolute z-10 mt-1 w-60 rounded-lg bg-white py-3 text-base shadow-sm outline-1 outline-black/5 data-closed:data-leave:opacity-0 data-leave:transition data-leave:duration-100 data-leave:ease-in sm:ml-auto sm:w-64 sm:text-sm"
                    >
                      {moods.map(mood => (
                        <ListboxOption
                          key={mood.value}

export default function Example() {
  return (
    <>
      ...
      <span className="inline-flex items-center rounded-md bg-red-50 px-2 py-1 font-medium text-red-700 text-xs ring-1 ring-red-600/10 ring-inset">
        Badge
      </span>
      ...
      <span className="inline-flex items-center rounded-md bg-indigo-50 px-2 py-1 font-medium text-indigo-700 text-xs ring-1 ring-indigo-700/10 ring-inset">
        Badge
      </span>
      <span className="inline-flex items-center rounded-md bg-purple-50 px-2 py-1 font-medium text-purple-700 text-xs ring-1 ring-purple-700/10 ring-inset">
        Badge
      </span>
      <span className="inline-flex items-center rounded-md bg-pink-50 px-2 py-1 font-medium text-pink-700 text-xs ring-1 ring-pink-700/10 ring-inset">
        Badge
      </span>
    </>
  );

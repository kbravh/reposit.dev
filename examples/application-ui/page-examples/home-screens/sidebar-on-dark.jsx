      ...
      <div>
        ...
        <div className="xl:pl-72">
          ...
          <main className="lg:pr-96">
            <header className="flex items-center justify-between border-white/5 border-b px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
              <h1 className="font-semibold text-base/7 text-white">
                Deployments
              </h1>

              {/* Sort dropdown */}
              <Menu as="div" className="relative">
                <MenuButton className="flex items-center gap-x-1 font-medium text-sm/6 text-white">
                  Sort by
                  <ChevronUpDownIcon
                    aria-hidden="true"
                ...
                >
                  <div className="min-w-0 flex-auto">
                    <div className="flex items-center gap-x-3">
                      ...
                      <h2 className="min-w-0 font-semibold text-sm/6 text-white">
                    ...
                    <div className="mt-3 flex items-center gap-x-2.5 text-gray-400 text-xs/5">
                  ...
                  <div
                    className={classNames(
                      ...
                      'flex-none rounded-full px-2 py-1 font-medium text-xs ring-1 ring-inset'
                    )}
                  >
          ...
          {/* Activity feed */}
          <aside className="bg-black/10 lg:fixed lg:top-16 lg:right-0 lg:bottom-0 lg:w-96 lg:overflow-y-auto lg:border-white/5 lg:border-l">
            <header className="flex items-center justify-between border-white/5 border-b px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
              <h2 className="font-semibold text-base/7 text-white">
                Activity feed
              </h2>
              <a href="#" className="font-semibold text-indigo-400 text-sm/6">
                View all
              </a>
            </header>
            <ul className="divide-y divide-white/5">
              {activityItems.map(item => (
                <li key={item.commit} className="px-4 py-4 sm:px-6 lg:px-8">
                  <div className="flex items-center gap-x-3">
                    ...
                    />
                    <h3 className="flex-auto truncate font-semibold text-sm/6 text-white">
                      {item.user.name}
                    </h3>
                    <time
                      dateTime={item.dateTime}
                      className="flex-none text-gray-600 text-xs"
                    >
                      {item.date}
                    </time>
                  </div>
                  <p className="mt-3 truncate text-gray-500 text-sm">
                    Pushed to{' '}

    ...
    <li className="flex flex-col gap-3 py-5 sm:flex-row sm:justify-between sm:gap-x-6">
      <div className="min-w-0 flex-auto">
        <div className="flex items-center gap-x-2">
          <p className="font-semibold text-gray-900 dark:text-white text-sm/6">
        ...
        {repository.repository.description && (
          <p className="mt-1 text-gray-500 dark:text-gray-400 text-sm/6 truncate">
            {repository.repository.description}
          </p>
        )}
        <div className="mt-2">
      ...
      <div className="flex shrink-0 items-start justify-end sm:items-center">
        <Menu as="div" className="relative flex-none">
          ...
          <MenuItems
            transition
            className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white dark:bg-gray-800 py-1 shadow-lg ring-1 ring-gray-900/5 dark:ring-gray-700/50 transition focus:outline-hidden data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-leave:duration-75 data-enter:ease-out data-leave:ease-in"
          >
            <MenuItem>
              <button
                onClick={() => {

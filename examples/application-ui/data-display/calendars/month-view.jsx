...
export default function Example() {
	return (
		<div className="lg:flex lg:h-full lg:flex-col">
			<header className="flex items-center justify-between border-gray-200 border-b px-6 py-4 lg:flex-none">
			...
			<div className="shadow-sm ring-1 ring-black/5 lg:flex lg:flex-auto lg:flex-col">
				<div className="grid grid-cols-7 gap-px border-gray-300 border-b bg-gray-200 text-center font-semibold text-gray-700 text-xs/6 lg:flex-none">
				...
				<div className="flex bg-gray-200 text-gray-700 text-xs/6 lg:flex-auto">
					...
					<ol className="divide-y divide-gray-100 overflow-hidden rounded-lg bg-white text-sm shadow-sm ring-1 ring-black/5">
						{selectedDay.events.map((event) => (
							...
							>
								...
								<a
									href={event.href}
									className="ml-6 flex-none self-center rounded-md bg-white px-3 py-2 font-semibold text-gray-900 opacity-0 shadow-xs ring-1 ring-gray-300 ring-inset hover:ring-gray-400 focus:opacity-100 group-hover:opacity-100"
								>

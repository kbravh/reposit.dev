  ...
  return (
    <div>
      <div className="relative grid grid-cols-1 gap-x-14 md:grid-cols-2">
        <button
          type="button"
          className="-top-1 -left-1.5 absolute flex items-center justify-center p-1.5 text-gray-400 hover:text-gray-500"
        >
        ...
        <button
          type="button"
          className="-top-1 -right-1.5 absolute flex items-center justify-center p-1.5 text-gray-400 hover:text-gray-500"
        >
      ...
      <section className="mt-12">
        ...
        <ol className="mt-2 divide-y divide-gray-200 text-gray-500 text-sm/6">

				...
				<div className="flex h-16 justify-between">
					...
					<div className="flex items-center">
						<div className="shrink-0">
							<button
								type="button"
								className="relative inline-flex items-center gap-x-1.5 rounded-md bg-indigo-600 px-3 py-2 font-semibold text-sm text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-indigo-600 focus-visible:outline-offset-2"
							>
			...
			<DisclosurePanel className="md:hidden">
				<div className="space-y-1 pt-2 pb-3">
					...
					<DisclosureButton
						as="a"
						href="#"
						className="block border-indigo-500 border-l-4 bg-indigo-50 py-2 pr-4 pl-3 font-medium text-base text-indigo-700 sm:pr-6 sm:pl-5"
					>
						Dashboard
					</DisclosureButton>
					<DisclosureButton
						as="a"
						href="#"
						className="block border-transparent border-l-4 py-2 pr-4 pl-3 font-medium text-base text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700 sm:pr-6 sm:pl-5"
					>
						Team
					</DisclosureButton>
					<DisclosureButton
				...
				<div className="border-gray-200 border-t pt-4 pb-3">
					...
					<div className="mt-3 space-y-1">
						<DisclosureButton
							as="a"
							href="#"
							className="block px-4 py-2 font-medium text-base text-gray-500 hover:bg-gray-100 hover:text-gray-800 sm:px-6"
						>
							Your Profile
						</DisclosureButton>
						<DisclosureButton

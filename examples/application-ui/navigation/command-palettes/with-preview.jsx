              ...
              <>
                ...
                {(query === '' || filteredPeople.length > 0) && (
                  ...
                  >
                    ...
                    >
                      {query === '' && (
                        <h2 className="mt-2 mb-4 font-semibold text-gray-500 text-xs">
                          Recent searches
                        </h2>
                      )}
                      <div className="-mx-2 text-gray-700 text-sm">
                        {(query === '' ? recent : filteredPeople).map(
                          person => (
                            <ComboboxOption
                              ...
                              key={person.id}
                              value={person}
                              className="group flex cursor-default select-none items-center rounded-md p-2 data-focus:bg-gray-100 data-focus:text-gray-900 data-focus:outline-hidden"
                            >
                              <img
                                src={person.imageUrl}
                                alt=""
                    ...
                    {activeOption && (
                      <div className="hidden h-96 w-1/2 flex-none flex-col divide-y divide-gray-100 overflow-y-auto sm:flex">
                        ...
                        <div className="flex flex-auto flex-col justify-between p-6">
                          <dl className="grid grid-cols-1 gap-x-6 gap-y-3 text-gray-700 text-sm">
                          ...
                          <button
                            type="button"
                            className="mt-6 w-full rounded-md bg-indigo-600 px-3 py-2 font-semibold text-sm text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-indigo-600 focus-visible:outline-offset-2"
                          >
                            Send message
                          </button>
                        </div>

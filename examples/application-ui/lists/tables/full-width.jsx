						...
						<table className="min-w-full divide-y divide-gray-300">
							<thead>
								<tr>
									<th
										scope="col"
										className="py-3.5 pr-3 pl-4 text-left font-semibold text-gray-900 text-sm sm:pl-6 lg:pl-8"
									>
										Name
									</th>
									<th
							...
							<tbody className="divide-y divide-gray-200 bg-white">
								{people.map((person) => (
									<tr key={person.email}>
										<td className="whitespace-nowrap py-4 pr-3 pl-4 font-medium text-gray-900 text-sm sm:pl-6 lg:pl-8">
											{person.name}
										</td>
										...
										<td className="relative whitespace-nowrap py-4 pr-4 pl-3 text-right font-medium text-sm sm:pr-6 lg:pr-8">
											<a
												href="#"

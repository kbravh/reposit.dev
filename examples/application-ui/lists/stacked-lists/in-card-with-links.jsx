...
export default function Example() {
	return (
		<ul className="divide-y divide-gray-100 overflow-hidden bg-white shadow-xs ring-1 ring-gray-900/5 sm:rounded-xl">
			{people.map((person) => (
				<li
					key={person.email}
				...
				>
					<div className="flex min-w-0 gap-x-4">
						...
						<div className="min-w-0 flex-auto">
							...
							<p className="mt-1 flex text-gray-500 text-xs/5">
								<a

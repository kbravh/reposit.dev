					...
					<tbody className="divide-y divide-gray-200 bg-white">
						{people.map((person) => (
							<tr key={person.email}>
								...
								<td className="hidden whitespace-nowrap px-3 py-4 text-gray-500 text-sm lg:table-cell">
									{person.email}
								</td>
								<td className="whitespace-nowrap px-3 py-4 text-gray-500 text-sm">
									{person.role}
								</td>
								<td className="whitespace-nowrap py-4 pr-4 pl-3 text-right font-medium text-sm sm:pr-0">

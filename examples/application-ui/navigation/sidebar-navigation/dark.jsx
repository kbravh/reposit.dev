								...
								<li key={item.name}>
									...
									>
										...
										{item.count ? (
											<span
												aria-hidden="true"
												className="ml-auto w-9 min-w-max whitespace-nowrap rounded-full bg-gray-900 px-2.5 py-0.5 text-center font-medium text-white text-xs/5 ring-1 ring-gray-700 ring-inset"
											>
												{item.count}
											</span>
										) : null}

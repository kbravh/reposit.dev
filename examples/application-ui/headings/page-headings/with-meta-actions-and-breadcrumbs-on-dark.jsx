  ...
  return (
    <div className="lg:flex lg:items-center lg:justify-between">
      <div className="min-w-0 flex-1">
          ...
          <ol className="flex items-center space-x-4">
            ...
            <li>
              <div className="flex items-center">
                ...
                <a
                  href="#"
                  className="ml-4 font-medium text-gray-300 text-sm hover:text-white"
                >
                  Engineering
                </a>
              </div>
        ...
        <h2 className="mt-2 font-bold text-2xl/7 text-white sm:truncate sm:text-3xl sm:tracking-tight">
          Back End Developer
        </h2>

        ...
        >
          {people.map(person => (
            <ListboxOption
              key={person.id}
              value={person}
              className="group relative cursor-default select-none py-2 pr-4 pl-8 text-gray-900 data-focus:bg-indigo-600 data-focus:text-white data-focus:outline-hidden"
            >

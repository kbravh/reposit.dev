							...
							>
								{filteredItems.map((item) => (
									<ComboboxOption
										key={item.id}
										value={item}
										className="group flex cursor-default select-none rounded-xl p-3 data-focus:bg-gray-100 data-focus:outline-hidden"
									>
										<div
										...
										<div className="ml-4 flex-auto">
											<p className="font-medium text-gray-700 text-sm group-data-focus:text-gray-900">
												{item.name}
											</p>
											<p className="text-gray-500 text-sm group-data-focus:text-gray-700">
												{item.description}
											</p>
										</div>
									</ComboboxOption>

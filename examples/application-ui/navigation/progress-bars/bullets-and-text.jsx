              ...
              {step.status === 'complete' ? (
                <a href={step.href} className="group">
                  <span className="flex items-start">
                    ...
                    <span className="ml-3 font-medium text-gray-500 text-sm group-hover:text-gray-900">
                      {step.name}
                    </span>
                  </span>
                </a>
                ...
                >
                  ...
                  <span className="ml-3 font-medium text-indigo-600 text-sm">
                    {step.name}
                  </span>
                </a>
              ) : (
                <a href={step.href} className="group">
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 font-medium text-gray-500 text-sm group-hover:text-gray-900">
                      {step.name}
                    </p>
                  </div>
                </a>

        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              ...
              <div className="rounded-lg bg-gray-50 shadow-xs ring-1 ring-gray-900/5">
                <dl className="flex flex-wrap">
                  <div className="flex-auto pt-6 pl-6">
                    <dt className="font-semibold text-gray-900 text-sm/6">
                      Amount
                    </dt>
                  ...
                  <div className="flex-none self-end px-6 pt-4">
                    ...
                    <dd className="rounded-md bg-green-50 px-2 py-1 font-medium text-green-600 text-xs ring-1 ring-green-600/20 ring-inset">
                      Paid
                    </dd>
                  </div>
                  <div className="mt-6 flex w-full flex-none gap-x-4 border-gray-900/5 border-t px-6 pt-6">
                    ...
                    <dd className="font-medium text-gray-900 text-sm/6">
                      Alex Curren
                    </dd>
                  </div>
            ...
            <div className="-mx-4 px-4 py-8 shadow-xs ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pt-16 xl:pb-20">
              <h2 className="font-semibold text-base text-gray-900">Invoice</h2>
              <dl className="mt-6 grid grid-cols-1 text-sm/6 sm:grid-cols-2">
                ...
                <div className="mt-6 border-gray-900/5 border-t pt-6 sm:pr-4">
                ...
                <div className="mt-8 sm:mt-6 sm:border-gray-900/5 sm:border-t sm:pt-6 sm:pl-4">
              ...
              <table className="mt-16 w-full whitespace-nowrap text-left text-sm/6">
                ...
                <thead className="border-gray-200 border-b text-gray-900">
                  <tr>
            ...
            <div className="lg:col-start-3">
              {/* Activity feed */}
              <h2 className="font-semibold text-gray-900 text-sm/6">
                Activity
              </h2>
                      ...
                      <>
                        ...
                        <div className="flex-auto rounded-md p-3 ring-1 ring-gray-200 ring-inset">
                          <div className="flex justify-between gap-x-4">
                            <div className="py-0.5 text-gray-500 text-xs/5">
                              <span className="font-medium text-gray-900">
              ...
              <div className="mt-6 flex gap-x-3">
                ...
                <form action="#" className="relative flex-auto">
                  <div className="-outline-offset-1 focus-within:-outline-offset-2 overflow-hidden rounded-lg pb-12 outline-1 outline-gray-300 focus-within:outline-2 focus-within:outline-indigo-600">
                      ...
                      <div className="flex items-center">
                        <Listbox value={selected} onChange={setSelected}>
                          ...
                          <div className="relative">
                            <ListboxButton className="-m-2.5 relative flex size-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
                            ...
                            <ListboxOptions
                              transition
                              className="-ml-6 absolute bottom-10 z-10 w-60 rounded-lg bg-white py-3 text-base shadow-sm ring-1 ring-black/5 focus:outline-hidden data-closed:data-leave:opacity-0 data-leave:transition data-leave:duration-100 data-leave:ease-in sm:ml-auto sm:w-64 sm:text-sm"
                            >
                              {moods.map(mood => (
                                <ListboxOption
                                  key={mood.value}

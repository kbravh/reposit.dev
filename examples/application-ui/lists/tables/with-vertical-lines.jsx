            ...
            <table className="min-w-full divide-y divide-gray-300">
              <thead>
                <tr className="divide-x divide-gray-200">
                  <th
                    scope="col"
                    className="py-3.5 pr-4 pl-4 text-left font-semibold text-gray-900 text-sm sm:pl-0"
                  >
                    Name
                  </th>
                  <th
                    scope="col"
                    className="px-4 py-3.5 text-left font-semibold text-gray-900 text-sm"
                  >
                    Title
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="py-3.5 pr-4 pl-4 text-left font-semibold text-gray-900 text-sm sm:pr-0"
                  >
                    Role
                  </th>
                </tr>
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {people.map(person => (
                  <tr key={person.email} className="divide-x divide-gray-200">
                    <td className="whitespace-nowrap py-4 pr-4 pl-4 font-medium text-gray-900 text-sm sm:pl-0">
                      {person.name}
                    </td>
                    ...
                    <td className="whitespace-nowrap py-4 pr-4 pl-4 text-gray-500 text-sm sm:pr-0">
                      {person.role}
                    </td>
                  </tr>
                ))}
